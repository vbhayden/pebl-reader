define(['./ModuleConfig', './PackageParser', './workers/WorkerProxy', 'StorageManager', 'i18nStrings', 'URIjs', './EpubLibraryOPDS'], function(moduleConfig, PackageParser, WorkerProxy, StorageManager, Strings, URI, EpubLibraryOPDS) {
            ...
            var dataSuccess = function(data) {
                ...
                if (moduleConfig.epubLibraryPath) {
                    for (var i = 0; i < data.length; i++) {
                        ...
                        data[i].contentPath = data[i].contentPath === undefined ? "OEDPS" : data[i].contentPath;
                        data[i].packageFile = data[i].packageFile === undefined ? "package.opf" : data[i].packageFile;
                    }
                }
